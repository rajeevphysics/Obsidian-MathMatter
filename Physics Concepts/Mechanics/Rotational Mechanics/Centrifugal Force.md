...
# Definition 
The centrifugal force is a fictitious force (not real) that is only valid in [[Frames of Reference| non-inertial frames of references]]. If an object is rotating around in a circle, the centrifugal force will point outwards.
